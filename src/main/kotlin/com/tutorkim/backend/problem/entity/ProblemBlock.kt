...
@Table(
	name = "problem_blocks",
	uniqueConstraints = [
		UniqueConstraint(name = "problem_blocks_order_unique", columnNames = ["problem_id", "sort_order"]),
	],
)
class ProblemBlock(
	@Id
	...
	fun validateAndTouch() {
		require(textContent != null || latexContent != null || fileAssetId != null) {
			"Problem block requires text, latex, or file content."
		}
